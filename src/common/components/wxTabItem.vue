  ...
  export default {
    ...
    computed: {
      tabSty() {
        ...
        if (!this.average) {
          width = this.$utils.widthpx2rem(this.data.tabWidth || this.tabWidth) + 'rem'
          marginLeft = this.$utils.widthpx2rem(this.data.tabMarginLeft || this.tabMarginLeft) + 'rem'
          if (this.data.tabMarginRight) marginRight = this.$utils.widthpx2rem(this.data.tabMarginRight) + 'rem'
        } else {
          flex = 1
        }
